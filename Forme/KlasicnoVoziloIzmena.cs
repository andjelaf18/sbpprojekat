...
{
    public partial class KlasicnoVoziloIzmena : Form
    {
        public KlasicnoVoziloIzmena()
        {
            InitializeComponent();
        }

        public KlasicnoVoziloView vozilo;

        public KlasicnoVoziloIzmena(KlasicnoVoziloView v)
        {
            InitializeComponent();
            this.vozilo = v;
        }
        ...
        private void popuniPodacima()
        {
            ...
            numericUpZapremina.Value = (decimal)vozilo.Zapremina;
            numericUpDownProsecnaPotrosnja.Value = (decimal)vozilo.ProsecnaPotrosnja;
            textBoxTipGoriva.Text = vozilo.TipGoriva;
        ...
        private void buttonIzmeniVozilo_Click(object sender, EventArgs e)
        {
            ...
            vozilo.Zapremina = (double)numericUpZapremina.Value;
            vozilo.ProsecnaPotrosnja = (double)numericUpDownProsecnaPotrosnja.Value;
            vozilo.TipGoriva = textBoxTipGoriva.Text;

            DTOManager.IzmeniKVozilo(vozilo);

            MessageBox.Show("Ažuriranje klasičnog vozila je uspešno izvršeno!");
            this.DialogResult = DialogResult.OK;
            this.Close();
        }

        private void KlasicnoVoziloIzmena_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
    }
